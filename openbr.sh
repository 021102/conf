...
if [[ -e /etc/openvpn/server.conf ]]; then
	...
	clear
	echo 'Instalador automatico OpenVPN'
	echo ""
	...
	echo ""
	echo "Primeiro precisaremos do ip da sua maquina,este ip está correto?"
	echo "listening to."
	...
	echo ""
	echo "Agora,digite o nome do seu primeiro usuario"
	echo "Use somente o nome, sem caracteres especiais"
	read -p "Client name: " -e -i client CLIENT
	echo ""
	echo "OpenVPN pronto para ser executado."
